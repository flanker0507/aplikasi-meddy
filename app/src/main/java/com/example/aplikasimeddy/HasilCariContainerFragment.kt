...
import com.example.aplikasimeddy.ui.adapter.ViewPagerHasilCariAdapter
...
class HasilCariContainerFragment: Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CariApotekFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CariApotekFragment().apply {
    ...
    private fun setupTabLayoutViewPager(){
        ...
        adapter.addFragment(SemuaHasilCariFragment(), "Semua")
        adapter.addFragment(ObatHasilCariFragment(), "Obat")
